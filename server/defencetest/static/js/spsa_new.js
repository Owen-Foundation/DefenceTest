...
function tcToSeconds(tc) {
  ...
  */
  let inc = 0;
  let moves = 68; /* DefenceTest average LTC game duration. */
  let time;
  let chunks = tc.split("+");
  if (chunks.length > 2) {
    return null;
...
/*
Now some code to convert DefenceTest style spsa data to spsa_setup
objects and back.
*/

function defencetestToSpsa(fs) {
