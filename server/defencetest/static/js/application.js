// Global variables
const defencetestBroadcastKey = "defencetest_broadcast";
...
function handleTabsBroadcasting() {
  window.addEventListener("storage", (event) => {
    if (event.key === defencetestBroadcastKey) {
...
function saveObject(key, value) {
  const key_ = `__defencetest__${key}`;
