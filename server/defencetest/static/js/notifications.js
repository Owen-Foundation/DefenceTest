...
const defencetestFollowLock = "defencetest_follow_lock";
...
function notifyDefenceTest_(message) {
...
function notifyDefenceTest(message) {
  broadcast("notifyDefenceTest_", message);
}
...
async function followRun(runId) {
  if (navigator.locks) {
    return navigator.locks.request(defencetestFollowLock, async (lock) => {
...
broadcastDispatch["notifyDefenceTest_"] = notifyDefenceTest_;
...
function cleanup_() {
  ...
  localStorage.removeItem("defencetest_disable_notification");
  localStorage.removeItem("defencetest_notifications");
  localStorage.removeItem("defencetest_notifications_v2");
  localStorage.removeItem("defencetest_timestamp");
  localStorage.removeItem("defencetest_timestamp_purge");
  localStorage.removeItem("__defencetest__latest_purge_time");
  localStorage.removeItem("__defencetest__latest_fetch_time_sig");
  localStorage.removeItem("__defencetest__latest_fetch_time");
}
