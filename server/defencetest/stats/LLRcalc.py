...
def MLE_expected(pdfhat, s):
    ...
    https://www.cantate.be/DefenceTest/support_MLE_multinomial.pdf
...
def MLE_t_value(pdfhat, ref, s):
    ...
    https://www.cantate.be/DefenceTest/normalized_elo_practical.pdf
...
def LLR_alt2(pdf, s0, s1):
    ...
    https://www.cantate.be/DefenceTest/GSPRT_approximation.pdf
    """
    s, var = stats(pdf)
