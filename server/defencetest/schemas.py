# This file describes some of the data structures used by DefenceTest so that they
...
from defencetest.constants import (
    PASSWORD_MAX_LENGTH,
...
action_username = union(username, "defencetest.system")
net_name = regex(r"nn-[a-f0-9]{12}.o2nn", name="net_name")
...
def compute_flags(run):
    ...
    if "sprt" in run["args"]:
        ...
        _, _, los = defencetest.stats.stat_util.get_elo(results["pentanomial"])
