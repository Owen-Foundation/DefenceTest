...
from defencetest.http import template_helpers as helpers
...
from defencetest.util import get_tc_ratio as _get_tc_ratio
...
TEMPLATES_DIR_ENV: Final[str] = "DEFENCETEST_JINJA_TEMPLATES_DIR"
...
def default_environment() -> Environment:
    ...
    globals_map: dict[str, Any] = {
        ...
        "poll": {
            ...
            "tests_run_tables": POLL_TESTS_RUN_TABLES_S,
            "tests_stats": POLL_TESTS_STATS_S,
            "tests_view_detail": POLL_TESTS_VIEW_DETAIL_S,
