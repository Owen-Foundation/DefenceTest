"""Install FastAPI and Starlette error handlers for the defencetest server.
...
from defencetest.http.ui_errors import render_forbidden_response, render_notfound_response
