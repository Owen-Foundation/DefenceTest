...
SESSION_COOKIE_NAME: Final[str] = "defencetest_session"
DEFAULT_SAMESITE: Final[Literal["lax", "strict", "none"]] = "lax"
INSECURE_DEV_ENV: Final[str] = "DEFENCETEST_INSECURE_DEV"
...
class MissingAuthenticationSecretError(RuntimeError):
    ...
    def __init__(self, env_name: str) -> None:
        ...
        message = (
            "Missing DEFENCETEST_AUTHENTICATION_SECRET "
...
def _secret_key() -> str:
    ...
    value = os.environ.get("DEFENCETEST_AUTHENTICATION_SECRET", "").strip()
    if not value:
