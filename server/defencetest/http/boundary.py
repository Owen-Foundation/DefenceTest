"""Bridge FastAPI requests to the legacy defencetest HTTP surface.
...
from defencetest.http.csrf import csrf_or_403
...
from defencetest.http.jinja import static_url
from defencetest.http.open_graph import default_open_graph
from defencetest.http.settings import SESSION_REMEMBER_ME_MAX_AGE_SECONDS
