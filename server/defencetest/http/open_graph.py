...
from defencetest.http.template_helpers import nelo_pentanomial_summary_text

if TYPE_CHECKING:
    from collections.abc import Iterable

_SITE_NAME = "DefenceTest"
_DEFAULT_DESCRIPTION = "Distributed testing framework for the Owen chess engine."
_TITLE_SUFFIX = " | DefenceTest"
