"""Persist defencetest sessions with Starlette-compatible middleware.

Wrap Starlette session behavior so defencetest can sign a JSON session payload and
...
class DefenceTestSessionMiddleware:
